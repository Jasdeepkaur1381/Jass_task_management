    ...
    : `
      ...
      `
        ...
        <div class='tags text-white d-flex flex-wrap'>
          <span class='badge bg-success m-1'>${type}</span>
        </div>
      </div>
...
//e will get a complete reference to the button from which bthis event has been trigerred
const deleteTask = (e) => {
  if (!e) e = window.event;
  ...
  // if you get this id dont add it in a new filter array
  // now udate a tasklist with the remove task
  //tasklist is the 
  updateLocalStorage();
  if (type === "BUTTON") {
...
const searchTask = (e) => {
  ...
  // this means getting the current object this we are using in edit, delete and close vof a card
  // in arrow function we can not directly use this
  // for using this keyword in arrow functio we are using apply function
